"""
TMDB API Broker - Handles all TMDB API calls.
No API key in code - fetched from Databricks secrets.
"""
...
def get_movie_details(movie_id: int) -> dict:
    """Get full movie details including cast and keywords."""
...
def build_movie_text(movie: dict) -> str:
    """Build text for embedding from movie data."""
    parts = []
    if movie.get("title"):
